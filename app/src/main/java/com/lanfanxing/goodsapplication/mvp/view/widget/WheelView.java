...
package com.lanfanxing.goodsapplication.mvp.view.widget;
...
import com.lanfanxing.goodsapplication.mvp.view.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// The number of first item_past_top_ranking in layout
	...
	/**
	 * Sets the current item_past_top_ranking. Does nothing when index is wrong.
	 * 
	 * @param index the item_past_top_ranking index
	...
	/**
	 * Sets the current item_past_top_ranking w/o animation. Does nothing when index is wrong.
	 * 
	 * @param index the item_past_top_ranking index
	 */
	...
	/**
	 * Tests if wheel is cyclic. That means before the 1st item_past_top_ranking there is shown the last one
	...
	/**
	 * Returns height of wheel item_past_top_ranking
	 * @return the item_past_top_ranking height
	 */
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.gray_line_bg));
		// 设置线宽
	...
	/**
	 * Creates item_past_top_ranking layouts if necessary
	 */
	...
	/**
	 * Adds view for item_past_top_ranking to items layout
	 * @param index the item_past_top_ranking index
	 * @param first the flag indicates if view should be first
	 * @return true if corresponding item_past_top_ranking exists and is added
	 */
	 ...
	 * @param index the item_past_top_ranking index
	 * @return true if item_past_top_ranking index is not out of bounds or the wheel is cyclic
	 */
	...
	/**
	 * Returns view for specified item_past_top_ranking
	 * @param index the item_past_top_ranking index
	 * @return item_past_top_ranking view or empty view if index is out of bounds
	 */
